...
$(document).ready(function () {
  tinymce.init({
    ...
    font_size_formats:
      "8pt 10pt 12pt 14pt 16pt 18pt 20pt 22pt 24pt 26pt 28pt 30pt 32pt 34pt 36pt 38pt 40pt 42pt 44pt 46pt 48pt 50pt 52pt 54pt 56pt 58pt 60pt 62pt 64pt 66pt 68pt 70pt 72pt 74pt 76pt 78pt 80pt 82pt 84pt 86pt 88pt 90pt 92pt 94pt 96pt 98pt 100pt",
    ...
    setup: function (editor) {
      editor.ui.registry.addToggleButton("temaoscuro", {
        text: "temaoscuro",
        onAction: (e) => {

     

          const elements = document.querySelectorAll(".tox-edit-area__iframe");
          ...
          if (iframes) {
            iframes.forEach((iframe) => {
              ...
              // Accede a elementos dentro del iframe
              let tinymceback = iframeDoc.querySelectorAll(".my_class");
              console.log(tinymceback);

              tinymceback.forEach(function (element) {
                element.style.background = "rgb(51, 51, 51)";
              });
            });
          }
        },
      ...
      editor.ui.registry.addToggleButton("temaclaro", {
        text: "temaclaro",
        onAction: (_) => {
          const elements = document.querySelectorAll(".tox-edit-area__iframe");
          elements.forEach(element => {
          ...
          if (iframes) {
            iframes.forEach((iframe) => {
              ...
              tinymceback.forEach(function (element) {
                element.style.background = "rgb(255, 255, 255)"; // Cambiar a color blanco
              });
            });
          }
        },
  ...
  }).trigger("change"); // Trigger change event to apply the logic on page load;
  $(".colorpicker")
    .colorpicker({
      onChange: function (e) {
        console.log("entro");
