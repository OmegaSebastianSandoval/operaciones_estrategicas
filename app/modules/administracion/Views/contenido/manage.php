      ...
      <div class="row">
        ...
        <div class="col-3 form-group">
          ...
          <label class="input-group">
            ...
            <input type="text"
              value="<?php if($this->content->contenido_fecha){ echo $this->content->contenido_fecha; } else { echo date('d-m-Y'); } ?>"
        ...
        <div
          class="col-3 <?php if($this->content->contenido_padre==0){ ?>d-none <?php } ?> form-group no-banner no-carrousel no-acordion si-seccion"
