        ...
        <div class="content-dashboard">
            <div class="row">
				...
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="reor_titulo" value="<?php echo $this->getObjectVariable($this->filters, 'reor_titulo') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            <label>imagen</label>
		            ...
		            <input type="text" class="form-control" name="reor_imagen" value="<?php echo $this->getObjectVariable($this->filters, 'reor_imagen') ?>"></input>
		            </label>
		        </div>
                <div class="col-3">
                    <label>&nbsp;</label>
	...
	<div class="content-dashboard">
		...
		<table class=" table table-striped  table-hover table-administrator text-left">
			...
			<tbody>
				...
				<?php $id =  $content->reor_id; ?>
					<tr>
						<td><?=$content->estado;?></td>
						<td><?=$content->reor_titulo;?></td>
						<td>
							<?php if($content->reor_imagen) { ?>
								<img src="/images/<?= $content->reor_imagen; ?>"  class="img-thumbnail thumbnail-administrator" />
							<?php } ?>
							<div><?= $content->reor_imagen; ?></div>
						</td>
						<td>
						...
						<td class="text-end">
							<div>
								...
								<a class="btn btn-verde btn-sm" href="/administracion/archivos?pertenecea=<?= $id ?>"  data-bs-toggle="tooltip" data-placement="top" title="Adjuntos"><i class="fas fa-file"></i></a>
