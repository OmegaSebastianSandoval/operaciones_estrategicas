...
class Administracion_Model_DbTable_Archivos extends Db_Table
{
	...
	public function insert($data){
		...
		$query = "INSERT INTO archivos( titulo, archivo, pertenecea) VALUES ( '$titulo', '$archivo', '$pertenecea')";
	...
	public function update($data,$id){
		...
		$archivo = $data['archivo'];
		$pertenecea = $data['pertenecea'];
		$query = "UPDATE archivos SET  titulo = '$titulo', archivo = '$archivo', pertenecea = '$pertenecea' WHERE id = '".$id."'";
		$res = $this->_conn->query($query);
	}
}