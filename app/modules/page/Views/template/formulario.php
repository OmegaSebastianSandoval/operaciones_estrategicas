<section class="bg-greenblue form-home">
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 col-lg-6">
                <form action="" id="form-contact" class="form-contact">

                    <div class="form-group">

                        <select name="servicio" id="servicio" class="form_input" required>
                    ...
                    <div class="row">
                        <div class="col-6 d-grid d-md-flex justify-content-center justify-content-md-between">
