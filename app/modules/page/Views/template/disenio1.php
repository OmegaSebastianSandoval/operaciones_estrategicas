<div data-aos="" class="caja-contenido-simple design-one" style="background-color: <?php if ($contenido->contenido_fondo_color) {
	...
	<div class="row">
		<div <?php if ($contenido->contenido_imagen) { ?>class="col-12 col-md-9" <?php } else { ?>class="col-sm-12" <?php } ?>>
